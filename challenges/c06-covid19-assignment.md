...
``` r
knitr::opts_knit$set(root.dir = "\\\\wsl.localhost/Ubuntu/home/ideluis42/Data-Science-SP25/challenges/")

setwd("\\\\wsl.localhost/Ubuntu/home/ideluis42/Data-Science-SP25/challenges/")

getwd()
```

    ## [1] "\\\\wsl.localhost/Ubuntu/home/ideluis42/Data-Science-SP25/challenges"

``` r
## TASK: Load the census bureau data with the following tibble name.

data_path <- "data/ACSDT5Y2018.B01003_2025-03-10T161941/county-data.csv"
df_pop <- 
  read_csv(data_path, skip = 1) |>
  subset(select = -c(...5)) |>
  as_tibble()
```
...
df_q3 <- 
  df_pop |> 
  mutate(fips = substr(Geography, nchar(Geography) - 5 + 1, nchar(Geography)))
```
