...
- Is there “one true value” for the material properties of Aluminum?
  - No, there are many values for the material properties of aluminum
- How many aluminum alloys are in this dataset? How do you know?
  - There is only one aluminum alloy in this dataset – al_24st. I know
    this because it’s the only value in the alloy column
- What angles were tested?
  - 0, 90, 45
- What thicknesses were tested?
  - 0.022, 0.032, 0.064, 0.081
- How does the material thickness and angle effect the elasticity (E)?
...
- Does this graph support or contradict the claim above?
  ...
  - This graph contradicts the claim above because elasticity appears to
    change with thickness

- Is this evidence *conclusive* one way or another?

  - It is not because other factors could’ve influenced the variation.
