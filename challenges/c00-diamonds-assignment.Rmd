...
-   There is a wide range of prices per carat, for example for diamonds that are 1.5 carats the price can range from \< \$5000 to \> \$15000
    -   There are minimum prices though – diamonds that are 2 carats or greater are never priced at lower that \$5000
...
-   A diamond's cut is correlated to its price – the better cut, the higher price

-   A diamond's cut does not seem to be correlated to how many carats it is

-   As the number of carats gets higher, the cut seems less important – there is a five carat diamond with a fair cut that is priced at higher than a two carat diamond with an ideal cut

-   There are less higher carat ideal cut diamonds – could be indicative of:

    -   It's harder to cut a higher carat diamond, or,

    -   There is less data on higher carat diamonds – this is more likely because there are significantly less data points between 3 and 5 carats than there is between 0 and 3 carats
