...
-   I wonder if Michelson filtered out outliers from his data, leading
    to a different mean
...
-   Is Michelson's estimate of the error (his uncertainty) greater or
    ...
    -   Michelson's estimate of the error is much less than the true
        error
...
-   It seems like the simulated and real values follow the same
    rise/fall pattern
...
-   There seems to be less of a range in simulated values than there is
    in real values
...
-   Data points are quite scattered – low-strength correlation
    -   Suggests that temperature alone does not fully explain
